...
class TransformerBlock(nn.Module):
    def __init__(self, layer_id: int, args: ModelArgs, freq_cis, mask):
        super().__init__()
...
class Transformer(nn.Module):
    def __init__(self, params: ModelArgs, seqlen: int):
        super().__init__()
        self.params = params
        ...
        if seqlen > 1:
            ...
            ).type_as(self.tok_embeddings.weight)
        ...
        for layer_id in range(params.n_layers):
            self.layers.append(TransformerBlock(layer_id, params, freqs_cis, mask))
